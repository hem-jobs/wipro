        ...
        <section class="pt-120 pb-120">
            <div class="container">
                <div class="contact-wrapper">
                    <div class="row">
                        <div class="col-lg-6 contact-thumb bg_img" data-background="<?=$assets?>/images/bg/bg-1.webp"></div>
                        ...
                        <div class="row mb-none-30">
                            ...
                            <div class="col-md-4 col-sm-6 mb-30">
                                <div class="contact-item">
                                    ...
                                    <div class="mt-4">
                                        <p><a href="/cdn-cgi/l/email-protection#8ce8e9e1e3cce1ede5e0a2efe3e1"><span class="__cf_email__" data-cfemail="2347464e4c63505653534c51570d404c4e">[email&#160;protected]</span></a></p>
                                        <p><a href="/cdn-cgi/l/email-protection#d5b1b0b8ba95b8b4bcb9fbb6bab8"><span class="__cf_email__" data-cfemail="8de9e8e0e2cdfef8fdfde2fff9a3eee2e0">[email&#160;protected]</span></a></p>
                                    </div>
                                </div><!-- contact-item end -->
                            </div>
                            <div class="col-md-4 col-sm-6 mb-30">
